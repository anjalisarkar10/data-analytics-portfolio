...
-- Insight: We have Users distrubuted across 14 countries. There are two instances where country value uses both english and regional name like 'Spain' and 'España' (1 user), 'Germany' and 'Deutschland' (4 users).
...
-- Insight: Found out 2 null product names,other than that there is no null values
